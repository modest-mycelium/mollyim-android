...
public final class SettingsValues extends SignalStoreValues {
  ...
  public static final String USE_MARKDOWN                             = "settings.markdown";
  ...
  public boolean isMarkdownEnabled() {
    return getBoolean(USE_MARKDOWN, false);
  }

  public void setMarkdownEnabled(boolean useMarkdown) {
    putBoolean(USE_MARKDOWN, useMarkdown); // TODO: actually make this configuration exist in ChatSettings
  }
